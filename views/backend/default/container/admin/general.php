          ...
          <div class="panel panel-default">
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                         <input class="form-control" name="blog_title" id="blog_title" type="text" value="<?php echo $this->blog_title;?>">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                         <input class="form-control" name="blog_tagline" id="blog_tagline" type="text" value="<?php echo $this->blog_tagline;?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                         <textarea class="form-control" name="blog_description" id="blog_description"><?php echo $this->blog_description;?></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                         <input class="form-control" name="blog_keywords" id="blog_keywords" type="text" value="<?php echo $this->blog_keywords;?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                         <input class="form-control" name="blog_url" id="blog_url" type="text" value="<?php echo $this->blog_url;?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                         <input class="form-control" name="admin_email" id="admin_email" type="text" value="<?php echo $this->admin_email;?>">
                    ...
                    <div class="col-md-9">
                         <select class="form-control" name="timezone" id="timezone">
                            <?php foreach($timezone as $zone){?>
                              <option value="<?php echo $zone;?>" <?php if($zone==$this->timezone): ?>selected="selected"<?php endif; ?>><?php echo $zone;?></option>
                              <?php }?>
                         </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                         <input class="form-control" name="date_format" id="date_format" type="text" value="<?php echo $this->date_format;?>">
                         <p class="help-block"></p>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                         <input class="form-control" name="time_format" id="time_format" type="text" value="<?php echo $this->time_format;?>">
                         <p class="help-block"></p>
                    </div>
                </div>
          </div>
