<div class="col-md-9">
  <div class="page-header">
    <h2 class="pull-left">Backend Themes</h2>
    <ol class="breadcrumb pull-right where-am-i">
      <li><a href="#">Themes</a></li>
      <li class="active">Backend Themes</li>
    </ol>
           ...
           foreach($themes as $theme){?>
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p><?php if($this->backend_theme != $theme['theme_name']){?>
                <form class="pull-left themeswitch" method="post">
                    <input type="hidden" name="backend_theme" value="<?php echo $theme['theme_name'];?>" />
